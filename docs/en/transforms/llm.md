...
If you use an OpenAI model, please refer to https://developers.openai.com/api/docs/models
for supported models and endpoints, including `/v1/chat/completions` where available.
